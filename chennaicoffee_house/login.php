...
if(isset($_POST['submit']))
{
   ...
   if($email!='' && $password!='')
   {
   $lg_qry=$conn->query("select * from user_table where email='$email' and password='$password'");

   if($lg_qry->rowCount()==1)
   {
      $lg_qry_arr=$lg_qry->fetch();
      $_SESSION['name']=$lg_qry_arr['fname'];
      ...
      <div class="col-12 col-lg-12 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h1 class="mb-4 pb-2 pb-md-0 offset-5 mb-md-5">Login Form</h1>
            <form method="post">
                ...
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" id="firstName" name="email" class="form-control form-control-lg" placeholder="Email" / required>
                ...
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="password" id="lastName" name="password" class="form-control form-control-lg" placeholder="Password"/ required>
